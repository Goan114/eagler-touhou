...
await copyFile(new URL("./audit-publication.mjs",import.meta.url),join(root,"scripts/audit-publication.mjs"));
await copyFile(new URL("./Build-eagler-runtimes.ps1",import.meta.url),join(root,"scripts/Build-eagler-runtimes.ps1"));
...
console.log("Publication audit scope: PASS (ignored / exported / force-added)");
