...
const entries = [
  ...
  ["vendor/marked.umd.js", true],
  ["vendor/purify.min.js", true],
  ["vendor/webaudio-tinysynth.min.js", true],
  ["vendor/fflate.LICENSE", false],
  ["vendor/marked.LICENSE", false],
  ["vendor/dompurify.LICENSE", false],
  ...
  ["NOTICE.txt", false],
  ["content/CHANGELOG.md", false],
  ["content/MULTIPLAYER.md", true],
  ["README.md", false],
  ["ASSETS.md", false],
...
export function hostArtworkFiles(games) {
  const files = games.flatMap(game => {
    ...
    return [...(product.cardArtwork ? [product.cardArtwork] : []), ...(game === "th06" ? ["th06.ico"] : [])];
  });
