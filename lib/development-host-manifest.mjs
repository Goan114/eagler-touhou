...
import { RESOURCE_MODE_HOSTED } from "../resource-mode.mjs";
...
export async function createDevelopmentHostManifest() {
  const games = {};
  ...
  return validateHostManifest({
    ...
    shared: { resourceMode: RESOURCE_MODE_HOSTED, ...DEVELOPMENT_CONTENT.shared },
    games,
  });
}
