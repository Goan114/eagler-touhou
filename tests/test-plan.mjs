...
export const REPOSITORY_NODE_TESTS = Object.freeze([
  ...
  "tests/test-quick-host-layout.mjs",
  "tests/test-language-pack-cache.mjs",
  "tests/test-host-config.mjs",
  "tests/test-host-kit-manifest.mjs",
  "tests/test-linux-first-install-relay-ownership.mjs",
  "tests/test-linux-first-install-hsts-policy.mjs",
