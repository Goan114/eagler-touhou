...
export const REPOSITORY_NODE_TESTS = Object.freeze([
  ...
  "tests/test-adapter-capabilities.mjs",
  "tests/test-adapter-contract-report.mjs",
  ...
  "tests/test-first-use-notice.mjs",
  "tests/test-multiplayer-guide.mjs",
  ...
  "tests/test-raw-data-import-policy.mjs",
...
export const WORKSPACE_NODE_TESTS = Object.freeze([
  ...
  "tests/test-required-gameplay-actions.mjs",
  ...
  "tests/test-midi-capability-contract.mjs",
  "tests/test-mobile-frame-pacing.mjs",
  "tests/test-native-frame-pacing.mjs",
  "tests/test-presentation-contract-coverage.mjs",
