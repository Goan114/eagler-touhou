...
const directory = resolve(process.argv[2] ?? '../interpret/worktrees/th10-plugins/artifacts/validation/th10-touch/runtime');
...
const incomplete = {...manifest.files}; delete incomplete['runtime/browser-worker.js'];
...
console.log(JSON.stringify({th10DirectoryRuntime: 'PASS', verifiedFiles: names.length, executableContentRejected: true, oldThreeFileContractPreserved: true}));
