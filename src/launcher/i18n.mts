...
const entries = [
  ...
  ["runtime.useCachedRuntime", "使用本地缓存", "Use local cache"],
  ["runtime.usingCachedRuntime", "正在使用本地 Runtime 缓存…", "Using cached local Runtime…"],
  ["runtime.restoringCachedRuntime", "正在切换到本地 Runtime 缓存…", "Switching to cached local Runtime…"],
  ["runtime.cachedRuntimeUnavailable", "无法使用本地 Runtime 缓存：{reason}", "Cached local Runtime is unavailable: {reason}"],
  ["runtime.cachedRuntimeCleanupFailed", "无法清理上次临时 Runtime 缓存：{reason}", "Could not clear the previous temporary Runtime cache: {reason}"],
  ...
  ["touch.thpracButtons", "thprac 按键", "thprac buttons"], ["touch.thpracButtonsHint", "显示模拟鼠标、作弊菜单、Tab 和 F12 按键。", "Show mouse emulation, cheat menu, Tab, and F12 buttons."], ["touch.advancedMenu", "高级选项", "Advanced options"],
  ...
  ["help.thpracReplayMobile", "在「触控设置」中启用 thprac 按键集合后，即可使用模拟鼠标、作弊菜单、Tab、F12 与 F1–F7。thprac 练习录像包含额外练习参数，播放时请保持 thprac 开启。", "Enable the thprac button set in Touch settings to use mouse emulation, cheat menu, Tab, F12, and F1–F7. Keep thprac enabled when playing practice replays."],
