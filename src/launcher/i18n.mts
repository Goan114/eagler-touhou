...
const entries = [
  ...
  ["diagnostics.netplayRuntime", "联机 房间 {room} - {role} - runtime {runtime} - build {build}{wipe}{states}{pause}", "Multiplayer room {room} - {role} - runtime {runtime} - build {build}{wipe}{states}{pause}"],
  ["diagnostics.transportSpectator", "只读 WS", "read-only WS"],
  ["diagnostics.transportConnecting", "连接中", "connecting"],
  ["diagnostics.network", "网络 {transport} - {route}{protocols}{families} - {peers}{failure}", "Network {transport} - {route}{protocols}{families} - {peers}{failure}"],
