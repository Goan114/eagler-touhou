...
const entries = [
  ["room.together", "一起，进入幻想乡", "A journey together"],
  ["room.players", "玩家席", "Your party"],
  ["room.takeHostSeat", "成为房主", "Become host"],
  ["room.hostAvailable", "P1 房主位空缺，入座后可修改房间设置。", "The P1 host seat is open. Take it to edit room settings."],
  ["room.host", "房主 · {name}", "Host · {name}"],
  ["room.playerOptions", "我的角色", "My character"],
  ["room.peerReady", "队友已准备好", "Your party is ready"],
  ["room.waitReady", "等待队友准备", "Waiting for your party"],
  ["room.tapSeat", "选择座位或加入观战", "Take a seat or join as a spectator"],
  ["room.connections", "连接详情", "Connection details"],
  ["room.done", "完成", "Done"],
  ["room.spectatorLounge", "观战席", "Spectators"],
  ["room.spectatorNumber", "观战者 {number}", "Spectator {number}"],
  ["room.spectatorHint", "加入后，在下一局开始时同步观战。", "Join now to watch together when the next game starts."],
  ["room.network", "连接质量", "Connection quality"],
  ...
  ["room.retry", "重新检测", "Test again"],
  ["room.direct", "直连", "Direct"],
  ["room.turn", "TURN", "TURN"],
  ["room.relay", "中继", "Relay"],
  ["room.checking", "检测中", "Testing"],
  ["room.unavailable", "不可用", "Unavailable"],
  ["room.jitter", "波动 {value} ms", "Variation {value} ms"],
  ["room.seatToTest", "入座后即可检测与其他玩家的连接。", "Take a seat to test your connection to the other players."],
  ["room.waitPeer", "队友入座后自动测延迟", "Latency testing starts when a teammate joins"],
  ["room.peerLeft", "这位玩家已离开座位。", "This player has left their seat."],
  ["room.pausedTest", "本局已开始，房间检测已暂停。实际链路请查看游戏内连接状态。", "Testing is paused during play. See the in-game connection status for the active route."],
  ["room.emptySeat", "等待加入", "Open seat"],
  ["room.notReady", "尚未准备", "Not ready"],
  ["room.ready", "已准备", "Ready"],
  ["room.online", "房间已连接", "Room connected"],
  ["room.lobby", "准备中", "In the lobby"],
  ["room.starting", "正在启动", "Starting"],
  ["room.running", "游戏中", "In game"],
  ["room.coop", "{count} 人合作", "{count}-player co-op"],
  ["room.watching", "等待开局", "Waiting for the next game"],
  ["library.singleplayer", "单机", "Single player"],
  ["library.multiplayer", "联机", "Multiplayer"],
  ["library.singleplayerHint", "选择一部作品，开始你的旅程", "Choose a game. Begin your journey."],
  ["library.multiplayerHint", "与朋友一起，进入幻想乡", "Explore Gensokyo together."],
  ["library.previous", "上一组", "Previous"],
  ["library.next", "下一组", "Next"],
  ["library.back", "返回游戏库", "Back to library"],
  ["library.quickNav", "快速导航", "Quick navigation"],
  ["library.holdNav", "点击选作，再点已选作品打开选项栏；长按滑动选作", "Tap to select, tap the selected title for options; hold and slide to browse"],
  ...
  ["gameNotice.creditBefore", "感谢 ", "Thanks to "],
  ["gameNotice.credit", "@SteinsGateON", "@SteinsGateON"],
  ["gameNotice.creditAfter", " 大大的逆向。", " for the reverse engineering."],
  ...
  ["options.touch", "触控设置", "Touch settings"],
  ["options.files", "存档 / 录像设置", "Saves & replays"],
  ["options.advanced", "高级设置", "Advanced settings"],
  ["options.adaptation", "适配测试中", "Adaptation in testing"],
  ...
  ["package.rawDataSizeMismatch", "{game} 原版数据大小不匹配：{actual}/{expected}", "{game} original data size mismatch: {actual}/{expected}"],
  ["package.validatingRawData", "正在校验 {game} 原版数据…", "Validating original {game} data…"],
  ["package.rawDataHashMismatch", "{game} 原版数据 SHA-256 校验失败", "{game} original data SHA-256 validation failed"],
  ["package.installingRawData", "正在安装 {game} 游戏数据…", "Installing {game} game data…"],
  ["package.installingRawDataProgress", "正在安装 {game} 游戏数据… {completed}/{total}", "Installing {game} game data… {completed}/{total}"],
  ...
  ["package.missingRequiredResource", "本地游戏包缺少当前 Runtime 必需资源：{resource}。请重新导入更新后的游戏包。", "The local game package is missing a resource required by the current Runtime: {resource}. Re-import an updated game package."],
  ...
  ["music.noneLaunchWarning", "将会在无音乐的情况下继续。\n如果想听正常的音乐，请在音乐中选择 OGG。", "The game will continue without music.\nIf you want normal music playback, choose OGG under Music."],
  ["music.midiLaunchWarning", "将会使用 MIDI 播放音乐。\n如果想听正常的音乐，请在音乐中选择 OGG。", "The game will continue with MIDI music.\nIf you want normal music playback, choose OGG under Music."],
  ["music.startAnyway", "仍要启动", "Start anyway"],
  ...
  ["runtime.preparingLocal", "准备 Runtime（下载约 1MB，若卡在这里，可以尝试断网）", "Preparing Runtime (about 1 MB; if it gets stuck here, try going offline)"],
  ...
  ["multiplayer.loadout.reimuC", "灵梦 C", "Reimu C"],
  ["multiplayer.loadout.marisaA", "魔理沙 A", "Marisa A"], ["multiplayer.loadout.marisaB", "魔理沙 B", "Marisa B"],
  ["multiplayer.loadout.marisaC", "魔理沙 C", "Marisa C"],
  ["multiplayer.loadout.sakuyaA", "咲夜 A", "Sakuya A"], ["multiplayer.loadout.sakuyaB", "咲夜 B", "Sakuya B"],
  ["multiplayer.loadout.th08.reimuYukari", "灵梦 & 紫", "Reimu & Yukari"],
  ["multiplayer.loadout.th08.marisaAlice", "魔理沙 & 爱丽丝", "Marisa & Alice"],
  ["multiplayer.loadout.th08.sakuyaRemilia", "咲夜 & 蕾米莉亚", "Sakuya & Remilia"],
  ["multiplayer.loadout.th08.youmuYuyuko", "妖梦 & 幽幽子", "Youmu & Yuyuko"],
  ["multiplayer.loadout.th08.reimu", "灵梦", "Reimu"],
  ["multiplayer.loadout.th08.yukari", "紫", "Yukari"],
  ["multiplayer.loadout.th08.marisa", "魔理沙", "Marisa"],
  ["multiplayer.loadout.th08.alice", "爱丽丝", "Alice"],
  ["multiplayer.loadout.th08.sakuya", "咲夜", "Sakuya"],
  ["multiplayer.loadout.th08.remilia", "蕾米莉亚", "Remilia"],
  ["multiplayer.loadout.th08.youmu", "妖梦", "Youmu"],
  ["multiplayer.loadout.th08.yuyuko", "幽幽子", "Yuyuko"],
  ["multiplayer.loadout.th09_0", "灵梦", "Reimu"], ["multiplayer.loadout.th09_1", "魔理沙", "Marisa"],
  ["multiplayer.loadout.th09_2", "咲夜", "Sakuya"], ["multiplayer.loadout.th09_3", "妖梦", "Youmu"],
  ["multiplayer.loadout.th09_4", "铃仙", "Reisen"], ["multiplayer.loadout.th09_5", "琪露诺", "Cirno"],
  ["multiplayer.loadout.th09_6", "莉莉卡", "Lyrica"], ["multiplayer.loadout.th09_7", "米斯蒂娅", "Mystia"],
  ["multiplayer.loadout.th09_8", "帝", "Tewi"], ["multiplayer.loadout.th09_9", "幽香", "Yuuka"],
  ["multiplayer.loadout.th09_10", "文", "Aya"], ["multiplayer.loadout.th09_11", "梅蒂欣", "Medicine"],
  ["multiplayer.loadout.th09_12", "小町", "Komachi"], ["multiplayer.loadout.th09_13", "四季映姬", "Shikieiki"],
  ["multiplayer.loadout.th09_14", "梅露兰", "Merlin"], ["multiplayer.loadout.th09_15", "露娜萨", "Lunasa"],
  ...
  ["dialog.errorTitle", "运行出错", "Runtime error"],
  ["dialog.copyError", "复制错误信息", "Copy error details"], ["dialog.errorCopied", "错误信息已复制", "Error details copied"],
  ["dialog.errorCopyFailed", "无法自动复制，请长按或选中错误信息复制", "Could not copy automatically; select the error details and copy them manually"],
  ["dialog.confirmTitle", "确认吗？", "Are you sure?"], ["firstUseNotice.title", "首次使用须知", "Before You Start"],
  ["browserWarning.title", "浏览器提示", "Browser notice"],
  ["browserWarning.message", "您正在使用不推荐的浏览器进行游戏。目前，当前浏览器有多起仅限于当前浏览器出现的bug的报告。我们建议您打开“常见问题”并下载推荐浏览器进行游戏。您仍然可以点击“继续访问网站”，但在游戏过程中可能出现各种其他浏览器中所没有的bug。", "You are using a browser we do not recommend. Several bugs have been reported that occur only in this browser. We suggest opening the FAQ and downloading a recommended browser. You can still click \"Continue to site\", but you may encounter bugs that do not appear in other browsers."],
  ["action.viewFaq", "查看常见问题", "View FAQ"],
  ["action.continueVisit", "继续访问网站", "Continue to site"],
  ...
  ["touch.thpracButtons", "thprac 按键", "thprac buttons"], ["touch.thpracButtonsHint", "显示作弊菜单、Tab、F12 和功能键。", "Show cheat menu, Tab, F12, and function keys."], ["touch.advancedMenu", "高级选项", "Advanced options"],
  ...
  ["help.thpracReplayMobile", "可以直接触碰操作 thprac 菜单；在「触控设置」中启用 thprac 按键集合后，还可使用作弊菜单、Tab、F12 与 F1–F7。thprac 练习录像包含额外练习参数，播放时请保持 thprac 开启。", "Touch thprac menus directly. Enable the thprac button set in Touch settings for the cheat menu, Tab, F12, and F1–F7. Keep thprac enabled when playing practice replays."],
