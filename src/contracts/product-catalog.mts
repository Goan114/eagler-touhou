...
export const PRODUCT_GAMES = Object.freeze({
  ...
  th10: Object.freeze({
    ...
    runtimeAssets: Object.freeze([
      ...
      "runtime/gles-main.mjs",
      "runtime/gles-game.mjs",
      "runtime/gles-platform.mjs",
      "runtime/native-file-store.mjs",
      "runtime/native-fonts.mjs",
      "runtime/native-memory.mjs",
      "runtime/encoding.mjs",
      "runtime/native-audio.mjs",
      "runtime/native-objects.mjs",
      "runtime/dsound.mjs",
      "runtime/com.mjs",
      "runtime/interfaces.mjs",
      "runtime/native-time.mjs",
      "runtime/native-input-state.mjs",
      "runtime/keyboard-state.mjs",
      "runtime/audio-bridge.mjs",
      "runtime/touch-driver.mjs",
      "runtime/touch-controls.mjs",
      "runtime/input.mjs",
      "runtime/assets.mjs",
      "runtime/gdi-fonts.mjs",
      "runtime/music-layout.mjs",
      "runtime/native-music-window.mjs",
      "runtime/storage.mjs",
      "runtime/asset-store.mjs",
      "runtime/audio-worklet.mjs",
      "runtime/audio-mixer.mjs",
      "vendor/th10-gles.mjs",
      "vendor/th10-gles.wasm",
      "fonts/blend.bin.gz",
      "fonts/128/32-400.json.gz",
      "fonts/128/34-400.json.gz",
      "fonts/128/36-400.json.gz",
      "fonts/128/38-400.json.gz",
      "fonts/128/40-400.json.gz",
      "fonts/128/42-400.json.gz",
      "fonts/128/44-400.json.gz",
      "fonts/128/46-400.json.gz",
      "fonts/128/48-400.json.gz",
      "fonts/128/50-400.json.gz",
      "fonts/128/52-400.json.gz",
      "fonts/128/54-400.json.gz",
      "fonts/128/56-400.json.gz",
      "fonts/128/58-400.json.gz",
      "fonts/128/60-400.json.gz",
    ]),
    dataProvider: "retail-memory",
    package: Object.freeze({
